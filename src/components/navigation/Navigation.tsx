...
const Navigation = () => {
  ...
  const handleItemClick = (itemName: string) => {
    ...
    if (itemName !== 'dashboard') {
      // For non-dashboard items, show a toast notification
      toast({
        title: "Navigation",
        description: `${itemName.charAt(0).toUpperCase() + itemName.slice(1)} section is under development`,
      });
    }
  };
  ...
  return (
    <nav className="flex items-center justify-between w-full px-5 py-3 bg-white border-b animate-slide-in-up">
      <div className="flex flex-col">
        <h1 className="text-h4 font-bold text-dark">Dashboard x</h1>
