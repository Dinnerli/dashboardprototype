...
const DevicesCard = () => {
  return (
    <Card className="w-full h-[555px] shadow-sm animate-slide-in-up bg-white overflow-hidden" style={{ animationDelay: '0.4s' }}>
      <div className="flex flex-col h-full p-6">
        {/* Header section */}
        <div className="flex justify-between items-center w-full pb-4 border-b border-[#E5E7EA]">
          <div className="flex items-center">
            <h3 className="font-bold text-xl text-[#233143]">Devices</h3>
          </div>
        ...
        <div className="flex flex-col h-full pt-6">
          ...
          <div className="flex gap-4 mb-6">
            {/* Desktop Option */}
            <div className="bg-[#F8F9FA] rounded-lg p-4 flex-1">
              <div className="flex items-start gap-2">
                {/* Blue vertical indicator */}
                <div className="w-1 h-12 bg-[#338FFF] rounded-full self-center"></div>
                
                <div className="flex-1">
                  {/* Title row */}
                  <div className="flex items-center gap-1 mb-1">
                    <span className="font-bold text-sm text-[#338FFF]">Desktop</span>
                    <Info size={14} className="text-[#8C9BAC]" />
                  </div>
            ...
            <div className="bg-[#F8F9FA] rounded-lg p-4 flex-1">
              <div className="flex items-start gap-2">
                ...
                <div className="w-1 h-12 bg-transparent rounded-full self-center"></div>
                
                <div className="flex-1">
                  {/* Title row */}
                  <div className="flex items-center gap-1 mb-1">
                    <span className="font-bold text-sm text-[#8C9BAC]">Mobile</span>
                    <Info size={14} className="text-[#8C9BAC]" />
                  </div>
