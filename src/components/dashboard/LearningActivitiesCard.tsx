        ...
        <div className="flex flex-col lg:flex-row p-6 gap-6">
          ...
          <div className="flex-1 flex justify-center items-center animate-float">
            <svg width="400" height="400" viewBox="0 0 400 401" fill="none" xmlns="http://www.w3.org/2000/svg" className="max-w-full h-auto">
              ...
              <text fill="#8C9BAC" xmlSpace="preserve" style={{ whiteSpace: "pre" }} fontFamily="Poppins" fontSize="16" fontWeight="600" letterSpacing="0em" className="animate-fade-in" style={{ animationDelay: '0.6s' }}><tspan x="125.023" y="18.6">Library</tspan></text>
              ...
              <text fill="#8C9BAC" xmlSpace="preserve" style={{ whiteSpace: "pre" }} fontFamily="Poppins" fontSize="16" fontWeight="600" letterSpacing="0em" className="animate-fade-in" style={{ animationDelay: '1.4s' }}><tspan x="127.648" y="51.1">Exams</tspan></text>
              ...
              <text fill="#8C9BAC" xmlSpace="preserve" style={{ whiteSpace: "pre" }} fontFamily="Poppins" fontSize="16" fontWeight="600" letterSpacing="0em" className="animate-fade-in" style={{ animationDelay: '2.2s' }}><tspan x="119.913" y="83.6">ILT/VILT</tspan></text>
              ...
              <text fill="#338FFF" xmlSpace="preserve" style={{ whiteSpace: "pre" }} fontFamily="Poppins" fontSize="16" fontWeight="600" letterSpacing="0em" className="animate-pulse-subtle"><tspan x="114.288" y="121.1">Courses</tspan></text>
            </svg>
          </div>
