      ...
      <div className="grid grid-cols-4 gap-4 py-6">
        ...
        >
          <div className={`absolute left-0 top-1/2 -translate-y-1/2 w-1 h-8 rounded-r transition-colors duration-300
            ${selectedStat === 'Active Users' ? 'bg-transparent' : 'bg-transparent'}`}
          ></div>
        ...
        {/* Repeat similar changes for other stats (Posts, Comments, Reactions) */}
        <div 
        ...
        >
          <div className={`absolute left-0 top-1/2 -translate-y-1/2 w-1 h-8 rounded-r transition-colors duration-300
            ${selectedStat === 'Posts' ? 'bg-transparent' : 'bg-transparent'}`}
          ></div>
          <div className="flex flex-col">
            <div className="flex items-center gap-1 mb-2">
              <span className={`font-medium transition-colors duration-300
        ...
        >
          <div className={`absolute left-0 top-1/2 -translate-y-1/2 w-1 h-8 rounded-r transition-colors duration-300
            ${selectedStat === 'Comments' ? 'bg-transparent' : 'bg-transparent'}`}
          ></div>
          <div className="flex flex-col">
            <div className="flex items-center gap-1 mb-2">
              <span className={`font-medium transition-colors duration-300
        ...
        >
          <div className={`absolute left-0 top-1/2 -translate-y-1/2 w-1 h-8 rounded-r transition-colors duration-300
            ${selectedStat === 'Reactions' ? 'bg-transparent' : 'bg-transparent'}`}
          ></div>
          <div className="flex flex-col">
            <div className="flex items-center gap-1 mb-2">
              <span className={`font-medium transition-colors duration-300
